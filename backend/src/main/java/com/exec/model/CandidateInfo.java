...
public class CandidateInfo {
    ...
    public CandidateInfo(String name, String roll_no, List<String> Campaigners, List<String> Proposers, List<String> Seconders, String manifesto_link, List<String> video_links, String poster_link, String post, Map<String,Integer> form_link) {
        this.name = name;
